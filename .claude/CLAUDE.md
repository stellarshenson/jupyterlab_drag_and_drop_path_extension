...
`jupyterlab_drag_and_drop_path_extension` is a JupyterLab 4 prebuilt frontend extension. It lets a user
...
- Python package `jupyterlab_drag_and_drop_path_extension`, built with `hatchling` and `hatch-jupyter-builder`
...
- `jupyterlab_drag_and_drop_path_extension/` - Python package
- `style/` - CSS assets
